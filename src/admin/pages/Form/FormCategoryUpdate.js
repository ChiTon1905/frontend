...
const FormCategoryUpdate = () => {
    ...
    const { category, setCategory, name, setName,updateCategory } = useCategory();
    ...
    useEffect(() => {
        const fetchCategories = async (e) => {
            try {
                ...
                console.log('axios', categoryData)
    
                setCategory(categoryData);
                setName(prevName => categoryData.data.attributes.cat_name || prevName);
        ...
        document.title = 'Categories Update';
