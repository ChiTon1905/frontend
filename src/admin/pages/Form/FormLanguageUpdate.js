...
const FormLanguageUpdate = () => {
    const { id } = useParams()

    const { languages, setLanguages, name, setName,updateLanguage } = useLanguages();
    ...
    useEffect(() => {
        const fetchLanguages = async (e) => {
            try {
                ...
                console.log('axios', LanguageData)
    
                setLanguages(LanguageData);
                setName(prevName => LanguageData.data.attributes.name || prevName);
        ...
        document.title = 'Languages Update';
        ...
        <div>
            <form className='mt-5 mr-5 ml-5'>
                ...
                <div className='mb-4 mr-5 '>
                    <button
                        type="submit"
                        onClick={handleUpdateLanguageSubmit}
...
export default FormLanguageUpdate